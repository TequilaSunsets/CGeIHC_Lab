	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (mainWindow.getToggle()) {
			...
			model = modelaux2 = glm::translate(model, glm::vec3(0.0f, 0.0, -8.0f));
			modelaux = model;
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//		PRIMER ARTICULACION CON SU BRAZO
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//		SEGUNDA ARTICULACION CON SU BRAZO
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//		TERCER ARTICULACION CON SU BRAZO
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//		CUARTA ARTICULACION CON LA SESTA O CABINA
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			modelaux = model = glm::translate(model, glm::vec3(0.0f, 0.0f, -8.0f));
			...
			modelaux2 = model = glm::rotate(model, glm::radians(mainWindow.getarticulacion11()), glm::vec3(0.0f, 1.0f, 0.0f));
			...
			modelaux3 = model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			...
			modelaux3 = model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			...
			model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			modelaux3 = model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, -1.0f, 0.0f));
			model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			...
			modelaux3 = model = glm::translate(model, glm::vec3(4.0f, 0.0f, 0.0f));
			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			...
			model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
			model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			modelaux3 = model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 1.0f, 0.0f));
			model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			...
			model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
			model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			modelaux3 = model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(0.0f, 1.0f, 0.0f));
			model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			...
			model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
			model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			modelaux3 = model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10()), glm::vec3(0.0f, -1.0f, 0.0f));
			model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
