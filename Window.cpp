...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	{
		theWindow->toggle = !(theWindow->toggle);
		...
		theWindow->articulacion7 = 0.0f;
		theWindow->articulacion8 = 0.0f;
		theWindow->articulacion9 = 0.0f;
		theWindow->articulacion10 = 0.0f;
		theWindow->articulacion11 = 0.0f;
	}
